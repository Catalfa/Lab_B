...
public class GeneralDao {
	 ...
	 * 
	 * @param url      L'URL del DB nel formato:
	 *                 jdbc:postgresql://localhost:numero_porta/nome_database.
	...
	public Connection openConnection() {
		try {
			...
			System.err.println(
					"ERRORE DI CONNESSIONE AL DATABASE, CONTROLLARE I DATI INSERITI O IL CORRETTO FUNZIONAMENTO DEL DATABASE");
			return null;
		}
